...
initLogger();
console.log("DEBUG: About to test app:", typeof electron.app);
if (typeof electron.app === "undefined") {
  console.error("ERROR: app is undefined!");
  const electron2 = require("electron");
  console.log("DEBUG: direct require electron:", typeof electron2);
  console.log("DEBUG: electron value:", electron2);
  console.log("DEBUG: electron length:", electron2?.length);
